-- Schema para o sistema de criptomoedas
-- Recriando todas as tabelas que foram excluídas
...
-- Tabela de histórico de mercados
...
ALTER TABLE latest_markets ENABLE ROW LEVEL SECURITY;
ALTER TABLE markets_history ENABLE ROW LEVEL SECURITY;
...
-- Políticas para inserção de notificações
